...
VALUES
-- root
(0, '首页', 'Home', '/', 0, 0, '5ecb64c5576af2642f7eacb4679c8fda', 'layout', FALSE, '/', '', TRUE, FALSE, TRUE, 0, 'admin', FALSE, TRUE),
-- 问题检索
(1, '问题检索', 'Search', '/search', 0, 1, '13348442cc6a27032d2b4aa28b75a5d3', 'layout', FALSE, '/search/probase', 'i_search', TRUE, FALSE, TRUE, 1, 'admin', FALSE, TRUE),
...
-- 表格工具
(4, '文档工具', 'Office', '/office', 0, 1, 'c1d81af5835844b4e9d936910ded8fdc', 'layout', FALSE, '/office/pdf2word', 'i_office', TRUE, FALSE, TRUE, 4, 'admin', FALSE, TRUE),
...
-- 通知管理
(9, '通知消息', 'Notify', '/notify', 0, 1, 'aaf9ed605d0193362321ba0def15c9b7', 'layout', FALSE, '/notify/message', 'i_notify', TRUE, FALSE, TRUE, 9, 'admin', FALSE, TRUE),
...
-- 信息维护
(12, '信息维护', 'Info', '/info', 0, 1, '4059b0251f66a18cb56f544728796875', 'layout', FALSE, '/info/department', 'i_info', TRUE, FALSE, TRUE, 12, 'admin', FALSE, TRUE),
...
-- 权限管理
(15, '权限管理', 'Manage', '/manage', 0, 1, '34e34c43ec6b943c10a3cc1a1a16fb11', 'layout', FALSE, '/manage/user', 'i_manage', TRUE, FALSE, TRUE, 15, 'admin', FALSE, TRUE),
...
-- 个人设置
(19, '个人设置', 'Setter', '/setter', 0, 1, '130bdeec588552954b9e3bea0ef364b2', 'layout', FALSE, '/setter/profile', 'i_setter', TRUE, FALSE, TRUE, 19, 'admin', FALSE, TRUE),

...
class MenuModel(base.ModelBase):
    ...
    name = Column(name="name", type_=String(55), nullable=False, comment="路由rtx-id，大驼峰命名方式")
    path = Column(name="path", type_=String(35), nullable=False, comment="路由path，全小写字母")
    title = Column(name="title", type_=String(35), nullable=False, comment="菜单名称")
    ...
    component = Column(name="component", type_=String(35), nullable=False, comment="路由组件，与Vue router mappings映射")
    ...
    icon = Column(name="icon", type_=String(35), comment="菜单图标")
